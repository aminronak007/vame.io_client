  ...
  return (
    <div>
      ...
      <div className="container white-box" style={{ marginTop: "40px" }}>
        <h5>Welcome to Vame!</h5>
        <div className="terms-1">
          <p>
            These terms and conditions outline the rules and regulations for the
            use of vame, located at vame.io.
          </p>
          <p>
            By accessing this website, we assume you accept these terms and
            conditions. Do not continue to use vame if you do not agree to take
          ...
          <p>
            ...
            subject to, prevailing law of Israel. Any use of the above
        ...
        <div>
          <h3>Cookies</h3>
          <p className="terms-1">
            We employ the use of cookies. By accessing vame, you agreed to use
            cookies in agreement with the vame Privacy Policy.
          </p>
          <p className="terms-1">
        ...
        <div>
          ...
          <div className="terms-1">
            <p>
              Unless otherwise stated, vame and/or its licensors own the
              intellectual property rights for all material on vame. All
              intellectual property rights are reserved. You may access this
              from vame for your own personal use subjected to restrictions set
              in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from vame</li>
              <li>Sell, rent or sub-license material from vame</li>
              <li>Reproduce, duplicate or copy material from vame</li>
              <li>Redistribute content from vame</li>
            </ul>
            <p>This Agreement shall begin on the date hereof.</p>
            <p>
              Parts of this website offer an opportunity for users to post and
              exchange opinions and information in certain areas of the website.
              vame does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of vame,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, vame
              ...
              and/or posting of and/or appearance of the Comments on vame.
            </p>
            <p>
              vame reserves the right to monitor all Comments and to remove any
          ...
          <div className="terms-1">
            ...
            <ul>
              ...
              <li>
                ...
                linking party’s site. No use of Company Name’s logo or other
        ...
        <div>
          ...
          <p className="terms-1">
            ...
            vame. You agree to protect and defend us against all claims that is
            rising on vame. No link(s) should appear on any Website that may be
