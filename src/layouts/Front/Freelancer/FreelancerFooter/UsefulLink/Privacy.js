    ...
    <div>
      ...
      <div className="container white-box" style={{ marginTop: "40px" }}>
        <div className="privacy-1">
          <p>
            At Vame, accessible from https://vame.io, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Vame and how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            that they shared and/or collect in Vame. This policy is not
            applicable to any information collected offline or via channels
            other than this website. Our Privacy Policy was created with the
            help of privacypolicygenerator.info
          </p>
        </div>
        <div>
          <div>
            <h3>Consent</h3>
            <p className="privacy-1">
          ...
          <div>
            <h3>Log Files</h3>
            <p className="privacy-1">
              Vame follows a standard procedure of using log files. These
          ...
          <div>
            ...
            <p className="privacy-1">
              Like any other website, Vame uses ‘cookies’. These cookies are
          ...
          <div>
            ...
            <div className="privacy-1">
              <p>
                ...
                the advertising partners of Vame.
              </p>
              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on Vame, which
              ...
              <p>
                Note that Vame has no access to or control over these cookies
          ...
          <div>
            ...
            <p className="privacy-1">
              Vame’s Privacy Policy does not apply to other advertisers or
          ...
          <div>
            ...
            <div>
              ...
              <p className="privacy-1">
                Vame does not knowingly collect any Personal Identifiable
